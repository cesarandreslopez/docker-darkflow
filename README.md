...
This is a Dockerfile / Docker image that will install for you within a container:
...
Python3, tensorflow 1.0, numpy, opencv 3. -- All dependencies handled by the Dockerfile
...
All installation of Darkflow has been taken care of from the Docker Container itself. All Darkflow credits go to https://github.com/thtrieu/darkflow.git
